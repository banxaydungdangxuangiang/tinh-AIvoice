...
import { CustomVoiceConfig, GenerationMode, GenerationParams, PrebuiltVoice, SavedPreset, Status } from './types';
...
import { SparklesIcon, UploadIcon, WaveformIcon } from './components/Icons';
